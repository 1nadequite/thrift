...
class User:
  ...
  thrift_spec = (
    ...
    (4, TType.I32, 'user_id', None, 0, ), # 4
    (5, TType.I32, 'sex', None, None, ), # 5
    (6, TType.BOOL, 'active', None, False, ), # 6
    (7, TType.STRING, 'description', None, None, ), # 7
  )

  def __init__(self, nickname=None, firstname=None, lastname=None, user_id=thrift_spec[4][4], sex=None, active=thrift_spec[6][4], description=None,):
...
class Message:
  ...
  def __init__(self, date=None, user=None, text=None,):
    self.date = date
    self.user = user
    self.text = text
